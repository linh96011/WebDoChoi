...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['addcart'])) {
    ...
    if ($productID > 0) {
        ...
        $result = $cart->add_to_cart($productID, $quantity);
        if ($result) {
            echo "<script>
            alert('Thêm vào giỏ hàng thành công!');
            window.location.href='pageproduct.php?productID=' + $productID;
          </script>";
            exit();
        } else {
            echo "<script>alert('Không thể thêm vào giỏ hàng.');</script>";
        }
    ...
    <div class="container">
        ...
        if ($getProduct) {
            ...
            <div class="page-product__breadcrumb">
                ...
                <a href="pageproductbycat.php?categoryID=<?php echo $resultProduct['categoryID']; ?>"
                    title="<?php echo $resultProduct['categoryName']; ?>"><?php echo $resultProduct['categoryName']; ?></a>
                <svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="bQfo7W">
                    <path
                        d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z">
                    </path>
                </svg>
                <a href="pageproductbyori.php?originID=<?php echo $resultProduct['originID']; ?>"
                    title="<?php echo $resultProduct['originName']; ?>"><?php echo $resultProduct['originName']; ?></a>
                <svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="bQfo7W">
                    <path
                        d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z">
                    </path>
                ...
                <a href="pageproduct.php?productID=<?php echo $resultProduct['productID']; ?>"
                    title="<?php echo $resultProduct['productName']; ?>"><?php echo $resultProduct['productName']; ?></a>
            </div>
                ...
                <div class="page-product__briefing-left">
                    ...
                    <div class="briefing-share">
                        <div class="briefing-share--item">
                            <p>Chia sẻ:</p>
                            <a href="#">
                                <div class="briefing-share--item-bg briefing-share--item-fm"></div>
                            </a>
                            <a href="#">
                                <div class="briefing-share--item-bg briefing-share--item-fb"></div>
                            </a>
                            <a href="#">
                                <div class="briefing-share--item-bg briefing-share--item-pinterest"></div>
                            </a>
                            <a href="#">
                                <div class="briefing-share--item-bg briefing-share--item-twitter"></div>
                            </a>
                        </div>
                        <div class="briefing-share--item">
                                ...
                                <a href="?productID=<?php echo $productID; ?>&action=unlike">
                                    <svg width="24" height="20" class="ELoIiZ">
                                        <path
                                            ...
                                            stroke="#FF424F" stroke-width="1.5" fill="#FF424F" fill-rule="evenodd"
                        ...
                        <div class="product-quantity">
                            ...
                            <div class="product-quantity-form">
                                <div class="product-quantity-control">
                                    <button type="button"
                                        onclick="this.parentNode.querySelector('input[type=number]').stepDown(); return false;">-</button>
                                    <input type="number" name="quantity" value="1" min="1"
                                        max="<?php echo $resultProduct['productQuantity']; ?>" />
                                    <button type="button"
                                        onclick="this.parentNode.querySelector('input[type=number]').stepUp(); return false;">+</button>
                                </div>
            ...
            <div class="page-product__similar">
                ...
                <ul class="similar-list">
                    ...
                    if ($similarProduct) {
                                ...
                                <a href="pageproduct.php?productID=<?php echo $resultSimilar['productID']; ?>">
                                    <div class="similar-item--link">
                                        <div class="similar-item--image">
                                            ...
                                            if ($getSimilarImage) {
                                                ?>
                                                <img src="admin/uploads/product/<?php echo $getSimilarImage->fetch_assoc()['productImage']; ?>"
                                                    alt="image" />
                                            <?php } ?>
                                        </div>
                                        <div class="similar-item--detail">
                                            ...
                                            <div class="similar-item--detail-price">
                                                <p class="price">
                                                    <span>₫</span><?php echo number_format($resultSimilar['productPrice']); ?>
                                                </p>
                                                <p class="sole">Đã bán <?php echo number_format($resultSimilar['productSold']); ?>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        echo '<p class="none-similar-item">Hiện Không có sản phẩm tương tự</p>';
                    } ?>
            </div>
        <?php } ?>
    </div>
