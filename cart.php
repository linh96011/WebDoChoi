...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete_cart']) && isset($_POST['cartID'])) {
        $cartID = $_POST['cartID'];
        if ($cart->delete_cart($cartID)) {
        ...
        <div class="container">
            <div class="cart-page-header-inner">
                <div class="cart-page-header-left">
                    <a href="index.php">
                        <svg viewBox="0 0 192 65" class="shopee-svg-icon icon-shopee-logo">
                            <g fill-rule="evenodd">
                                <path
        ...
        <div class="container">
            <div class="cart-page-content">
                <div class="cart-page-content-notice">
                    <svg height="12" viewBox="0 0 20 12" width="20" class="shopee-svg-icon _2Ns6ZJ icon-free-shipping">
                        ...
                        <div class="cart-page-content-section" id="<?php echo $result['cartID']; ?>">
                                    ...
                                    <div class="cart-item__content">
                                        <div class="cart-item__cell-overview">
                                            <a href="pageproduct.php?productID=<?php echo $result['productID']; ?>"
                                                ...
                                                <div class="cart-item__cell-overview--image"><img
                                                        src="admin/uploads/product/<?php echo $result['productImage']; ?>"
                                                        alt="image" /></div>
                                        ...
                                        <div class="cart-item__cell-variation">
                                            <p>Phân Loại Hàng:<i
                                                    class="fas fa-sort-down"></i><span><?php echo $result['categoryName']; ?></span>
                                            </p>
                                        </div>
                            ...
                            <div class="cart-page-content-section__shipping">
                                <svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0"
                                    ...
                                    <g>
                                        <line fill="none" stroke-linejoin="round" stroke-miterlimit="10" x1="8.6" x2="4.2"
                                            y1="9.8" y2="9.8"></line>
                                ...
                                <span>Miễn Phí Vận Chuyển cho đơn hàng từ ₫0 (giảm tối đa ₫30.000); Miễn Phí Vận Chuyển cho đơn
                                    hàng từ ₫300.000 (giảm tối đa ₫70.000)</span>
                            </div>
                        </div>
                    <?php }
                } ?>
